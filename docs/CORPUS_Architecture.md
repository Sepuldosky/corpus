...
| **Block 3** | Coagulant (médico jugador, estilo ACE3 — heridas por zona, sangrado, vitales, tratamiento, debuffs zonales y UI) | **Cerrado (2026-07-20).** Los 4 slices verificados en juego (rondas 1-7; la 7 pasó 13/13 e incluyó el modo degradado sin Cargo) y los fixes post-cierre confirmados en la mini-ronda 8. Restan un check menor y dos decisiones de diseño abiertas. Doc particular: `corpus-coagulant/docs/Coagulant_Architecture.md`; foto en su `coagulant_estado.md` |
